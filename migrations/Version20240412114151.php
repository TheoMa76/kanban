...
final class Version20240412114151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history (id INT AUTO_INCREMENT NOT NULL, task_id INT DEFAULT NULL, event VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, event_date DATETIME NOT NULL, details VARCHAR(255) NOT NULL, INDEX IDX_27BA704B8DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE history ADD CONSTRAINT FK_27BA704B8DB60186 FOREIGN KEY (task_id) REFERENCES task (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE history DROP FOREIGN KEY FK_27BA704B8DB60186');
